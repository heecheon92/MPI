...
silent only
cd ~/HPPython_reserch/benchmarks/MISC
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/MPICH/mpi_matmul_sr_512.c
badd +0 c_pylib.c
argglobal
silent! argdel *
$argadd ~/MPICH/mpi_matmul_sr_512.c
edit c_pylib.c
...
wincmd w
argglobal
if bufexists('~/MPICH/mpi_matmul_sr_512.c') | buffer ~/MPICH/mpi_matmul_sr_512.c | else | edit ~/MPICH/mpi_matmul_sr_512.c | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
